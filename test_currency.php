...
<form action="" class="google_ads_income needs-validation" novalidate="" method="POST">
    ...
    <div class="form-group">
        ...
        <input type="number" name="charge_rate" id="validationTooltip01" placeholder="مبلغ شارژ را وارد کنید."
            required="">
...
document.getElementById('validationTooltip01').addEventListener('input', function(event) {
    ...
    // نمایش نتیجه
    document.getElementById('alertMessage').textContent = "مبلغ محاسبه‌شده: " + result.toLocaleString() +
        " تومان";
