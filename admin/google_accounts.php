                            ...
                            <div class="collapse" id="filteringBox">
                                <div class=" border border-1 rounded p-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-2">
                                                <select id="currencyCode" class="form-control form-select lgSelect"
                                                    data-placeholder="نوع ارز" tabindex="1">
                                        ...
                                        <div style="display: flex; align-items: center; gap: 10px; flex-wrap: nowrap;">
                                            ...
                                            <form action="" method="POST"
                                                ...
                                                <input class="form-control" style="width: 200px;"
                                                    value="<?= $account['cid'] ?>" readonly>
                                                <button name="delete_cid" class="btn btn-primary">حدف اکانت
                                                    آیدی</button>
                                            </form>
                                            <?php else: ?>
                                            <form action="" method="POST"
                    ...
                    <nav>
                        <ul class="pagination justify-content-center">
                            <li class="page-item <?= ($page <= 1) ? 'disabled' : '' ?>">
                                <a class="page-link"
                                    href="?page=<?= max(1, $page - 1) ?>&search=<?= urlencode($search) ?>">قبلی</a>
                            </li>
                            ...
                            <li class="page-item <?= ($page >= $total_pages) ? 'disabled' : '' ?>">
                                <a class="page-link"
                                    href="?page=<?= min($total_pages, $page + 1) ?>&search=<?= urlencode($search) ?>">بعدی</a>
                            </li>
                        </ul>
                    </nav>
