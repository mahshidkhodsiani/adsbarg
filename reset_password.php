      ...
      <div class="position-relative overflow-hidden radial-gradient min-vh-100">
        <div class="position-relative z-index-5">
                    ...
                    <div class="authentication-login min-vh-100 bg-body row justify-content-center align-items-center p-4" style="background: #f8f8f9 !important;
                        ...
                        <div class="tab-content">
                            ...
                            <form action="" method="POST">
                                ...
                                <div class="form-floating mb-3">
                                    <input name="new_pass" type="password" class="form-control" id="txtQuery2" placeholder="Enter pass here">
                                    <label for="gEmail">
                                    <i class="fa fa-user me-1"></i>پسورد جدید : </label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input name="new_pass_again" type="password" class="form-control" id="txtQuery2" placeholder="Enter pass here again">
                                    <label for="gEmail">
                                    <i class="fa fa-user me-1"></i>تکرار پسورد جدید : </label>
                                </div>
            ...
            <?php
                ...
                echo "<alert>مشکلی پیش آمده لطفا دوباره تلاش کنید </alert>";
            }
            ?>
...
if (isset($_POST['submit'])) {
    ...
    if($_POST['new_pass'] == $_POST['new_pass_again']) {
        ...
        echo "<script>alert('پسوردهای وارد شده مطابقت دوباره تلاش کنید')</script>";
    }
