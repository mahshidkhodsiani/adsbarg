        ...
        <div class="container border mt-3 rounded  mb-3">
            <div class="row">
                ...
                <div class="col-md-6" style="text-align: left;">
                    ...
                    <?php
                        ...
                        <a id="back" class="btn btn-outline-primary btn-sm" href="services.php">بازگشت <i class="fa fa-arrow-left me-1"></i></a>
                    <?php
                        endif; ?>
                </div>
            </div>
            ...
            if (isset($_POST['charge'])){
                ...
                if (isset($_POST['amount_service_click']) && $_POST['amount_service_click'] != '') {
                    ...
                    $cid = $_POST['this_account'];
                    $amount = $_POST['amount_service_promotion'];
                    $stmt = $conn->prepare("INSERT INTO orders (user_id, account_id, amount, status, shenaseh, type, created_at) VALUES (?, ?, ?, ?, ?, 'promotion', NOW())");
                    $random = generateRandomID(); 
                    $status = 2; 
                    $stmt->bind_param("issis", $id, $cid, $amount, $status, $random);
                    // Execute the statement
...
if (isset($_POST['submit'])) {
    ...
    if(isset($_POST['amount_service_promotion'])){
        $update_account = "UPDATE accounts SET get_promotion = 1 WHERE id  =$cid";
